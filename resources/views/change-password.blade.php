                ...
                <div class="w-full mx-auto gap-x-2">
                    <form action="/change/password/{{ $id }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="password" name="password" placeholder="Input New Password" class="w-80 py-3 border-b-2 block shadow-md border-purple-500 px-1">
                        </div>
                        <div class="mb-4">
                            <label class="font-bold mb-1 block">Confirm password</label>
                            <input type="password" name="password_confirmation" placeholder="Confirm password" class="w-80 py-3 border-b-2 block shadow-md border-purple-500 px-1">
                        </div>
