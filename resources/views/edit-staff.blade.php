    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <div class="px-8 mt-4">
            <div class="bg-white py-8 px-10">
                <h1 class="text-2xl font-bold mb-4">Edit Staff Details</h1>
                <div class="w-full mx-auto gap-x-2">
                    <form action="/edit/staff/{{ $staff->id }}" enctype="multipart/form-data" method="post" class="w-8/12 grid grid-cols-2 gap-x-4 mx-auto mt-4 items-center">
                        @csrf
                        <div class=" mb-3">
