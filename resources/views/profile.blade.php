    ...
    <main class="w-full h-screen overflow-y-scroll">
        ...
        <div class="px-2 md:px-5 mt-4">
            <div class="bg-white py-8 md:px-10 px-3">
                <h1 class="text-xl md:text-2xl font-bold mb-4">Edit My Profile</h1>
                <div class="w-full mx-auto gap-x-2">
                    <form action="/edit/profile" method="post" class="w-full md:w-8/12 grid md:grid-cols-2 gap-x-4 mx-auto mt-4 items-center">
                        @csrf
                        <div class=" mb-3">
